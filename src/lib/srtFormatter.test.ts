import { formatTimeSRT, formatTimeVTT, generateSRT, parseTimestampToSeconds, sanitizeAndFixOverlaps, splitLongSubtitleItem, mergeChunkSubtitles } from './srtFormatter';
...
test('sanitizeAndFixOverlaps deduplicates IDs', () => {
...
test('sanitizeAndFixOverlaps tight overlap', () => {
